function fun=shape_fun(points,i,ndim,nod)
% !   This subroutine computes the values of the shape functions.
% !   to local coordinates
fun=zeros(nod,1);
pt125=0.125; pt25=0.25; pt5=0.5; pt75=0.75;  ...
    ...
    case 2 % 2D element
        ...
        switch nod
            case 3
                fun=[c1;c3;c3];
            case 6
                %             fun=[(2*c1-1)*c1;4*c3*c1;(2*c3-1)*c3;4*c2*c3;(2*c2-1)*c2;4*c1*c2];
                fun(1)=(two*c1-one)*c1;
                fun(2)=d4*c3*c1;
                fun(3)=(two*c3-one)*c3;
                fun(4)=d4*c2*c3;
