function pl=mcdpl(phi,psi,dee,stress)
% ! This subroutine forms the plastic stress/strain matrix
% ! for a Mohr-Coulomb material (phi,psi in degrees).
zero=0.0;pt49=0.49;one=1.0;two=2.0;
d3=3.0;d4=4.0;d6=6.0;d180=180.0;
ih=length(stress);
dfds=zeros(ih,1);
dqds=zeros(ih,1);
% ddqds=zeros(ih,1);
